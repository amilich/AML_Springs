...
public class ForceSpringApp2 extends AbstractSimulation {
	...
	public static void main(String[] args) {
		SimulationControl control = SimulationControl.createApp(new ForceSpringApp2()); //creates simulation implementing this class
